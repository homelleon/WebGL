...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__engine_core_Extentions__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__engine_core_Tools__ = __webpack_require__(40);
...
window.requestAnimFrame = function () {
	return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.onRequestAnimationFrame || window.msRequestAnimationFrame || function (callback, element) {
...
function Vector3f(x, y, z) {
	...
	this.sub = function (leftVector, rightVector) {
		if (!rightVector) {
			...
			return new Vector3f(leftVector.x - rightVector.x, leftVector.y - rightVector.y, leftVector.z - rightVector.z);
		}
	};
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__manager_VAOManager__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__control_Inputs__ = __webpack_require__(37);
...
function Matrix4f() {
  ...
  */
    ...
    */
	...
	this.determinant3x3 = function (t00, t01, t02, t10, t11, t12, t20, t21, t22) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__math_matrix_Matrix4f__ = __webpack_require__(3);
...
function Camera(name) {
	...
	this.move = function () {
		...
		var dx = forwardDistance * Math.sin(Math.toRadians(-_yaw)) + strafeDistance * Math.sin(Math.toRadians(-_yaw + 90));
		var dy = forwardDistance * Math.sin(Math.toRadians(_pitch)) + strafeDistance * Math.cos(Math.toRadians(_pitch + 90));
		var dz = forwardDistance * Math.cos(Math.toRadians(-_yaw)) + strafeDistance * Math.cos(Math.toRadians(-_yaw + 90));
...
function VAO() {
	// initialization
	var _object = __WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].createVertexArray();
	var _vbos = [];
  ...
  */
	this.bind = function () {
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].bindVertexArray(_object);
	};
  ...
  */
	this.clean = function () {
		...
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].deleteVertexArray(_object);
	};
...
function MainRenderer() {
	...
	__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].enable(__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].DEPTH_TEST);
  ...
  */
	this.render = function (scene) {
		...
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].clear(__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].COLOR_BUFFER_BIT || __WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].DEPTH_BUFFER_BIT);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__math_matrix_Matrix4f__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__math_vector_Vector3f__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__object_camera_Camera__ = __webpack_require__(4);
...
function EntityRenderer(projectionMatrix) {
  ...
  */
	this.render = function (scene) {
		...
		__WEBPACK_IMPORTED_MODULE_1__index_js__["gl"].drawElements(__WEBPACK_IMPORTED_MODULE_1__index_js__["gl"].TRIANGLES, vao.getIndexBuffer().getSize(), __WEBPACK_IMPORTED_MODULE_1__index_js__["gl"].UNSIGNED_SHORT, 0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__math_vector_Vector3f__ = __webpack_require__(1);
...
function EntityShader() {
	...
	this.loadLights = function (lights) {
		for (let i = 0; i < MAX_LIGHTS; i++) {
			if (i < lights.length()) {
				this.load3DVector(UNIFORM_LIGHT_POSITION + "[" + i + "]", lights.get(i).getPosition());

				this.load3DVector(UNIFORM_LIGHT_COLOR + "[" + i + "]", lights.get(i).getColor());

				this.load3DVector(UNIFORM_LIGHT_ATTENUATION + "[" + i + "]", lights.get(i).getAttenuation());
			} else {
				this.load3DVector(UNIFORM_LIGHT_POSITION + "[" + i + "]", new __WEBPACK_IMPORTED_MODULE_1__math_vector_Vector3f__["a" /* Vector3f */](0, 0, 0));

				this.load3DVector(UNIFORM_LIGHT_COLOR + "[" + i + "]", new __WEBPACK_IMPORTED_MODULE_1__math_vector_Vector3f__["a" /* Vector3f */](0, 0, 0));

				this.load3DVector(UNIFORM_LIGHT_ATTENUATION + "[" + i + "]", new __WEBPACK_IMPORTED_MODULE_1__math_vector_Vector3f__["a" /* Vector3f */](1, 0, 0));
			}
		}
	};
...
function ShaderProgram() {
	// initialization	
	var _programObject = __WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].createProgram();
	...
	// methods
	this.start = function () {
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].useProgram(_programObject);
	};
	...
	this.clean = function () {
		...
		if (_vertexShaderObject) {
			__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].detachShader(_programObject, _vertexShaderObject);
		}

		if (_fragmentShaderObject) {
			__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].detachShader(_programObject, _fragmentShaderObject);
		}
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].deleteShader(_fragmentShaderObject);
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].deleteShader(_vertexShaderObject);
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].deleteProgram(_programObject);
	};
	...
	this.compileShaders = function compileShader() {
		this.bindAttributes();
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].linkProgram(_programObject);

		if (!__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].getProgramParameter(_programObject, __WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].LINK_STATUS)) {
			console.log(__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].getProgramInfoLog(_programObject, 1024));
			return null;
		}
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].validateProgram(_programObject);

		if (!__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].getProgramParameter(_programObject, __WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].VALIDATE_STATUS)) {
			console.log(__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].getProgramInfoLog(_programObject, 1024));
			return null;
		}
	...
	var loadShader = function (source, type) {
		...
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].attachShader(_programObject, shaderID);
		return shaderID;
	};

	this.addVertexShader = function (text) {
		_vertexShaderObject = loadShader(text, __WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].VERTEX_SHADER);
	};

	this.addFragmentShader = function (text) {
		_fragmentShaderObject = loadShader(text, __WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].FRAGMENT_SHADER);
	};
	...
	var getUniformLocation = function (name) {
		return __WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].getUniformLocation(_programObject, name);
	};
	...
	this.bindAttribute = function (attribute, name) {
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].bindAttribLocation(_programObject, attribute, name);
	};

	this.bindFragOutput = function (attribute, name) {
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].bindFragDataLocation(_programObject, attribute, name);
	};
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__object_camera_Camera__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__object_light_Light__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__primitive_Model__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__primitive_Mesh__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__primitive_Material__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__math_vector_Vector3f__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__primitive_VAO__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__core_Loop__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__loader_objectLoader_OBJLoader__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__texture_Texture__ = __webpack_require__(32);
...
function Scene() {
	...
	// prepare lights
	var sun = new __WEBPACK_IMPORTED_MODULE_3__object_light_Light__["a" /* Light */](new __WEBPACK_IMPORTED_MODULE_7__math_vector_Vector3f__["a" /* Vector3f */](1000, 5000, 1000), new __WEBPACK_IMPORTED_MODULE_7__math_vector_Vector3f__["a" /* Vector3f */](1.3, 1.3, 1.3));

	_lights.add(sun);

	// prepare entities
	var entityTexture = new __WEBPACK_IMPORTED_MODULE_11__texture_Texture__["a" /* Texture */]("spartanTexture", "spartan.png");
...
function VBO(type) {
	// initialization
	var _object = __WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].createBuffer();
	var _type = type;
	var _size = 0;
	var _dimentions = 0;
  ...
  */
	this.bind = function () {
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].bindBuffer(_type, _object);
	};
  ...
  */
	this.unbind = function () {
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].bindBuffer(_type, null);
	};
  ...
  */
	this.storeData = function (values, dimentions) {
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].bufferData(type, new Float32Array(values), __WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].STATIC_DRAW);
  ...
  */
	this.storeIndexData = function (values) {
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].bufferData(type, new Uint16Array(values), __WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].STATIC_DRAW);
		_size = values.length;
	};
  ...
  */
	this.clean = function () {
		__WEBPACK_IMPORTED_MODULE_0__index_js__["gl"].deleteBuffer(_object);
	};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__core_Loop__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__primitive_Mesh__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__math_vector_Vector2f__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__math_vector_Vector3f__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Vertex__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Polygon__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__PolygonGroup__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__SmoothingGroup__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Face__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__MeshObject__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__LoaderUtil__ = __webpack_require__(8);
...
function OBJLoader(generateTangents) {
  ...
  */
	this.load = function (path, objFile, mtlFile) {
		...
		// loading .obj file
		try {
			__webpack_require__(29)("./" + path + objFile + '.obj');
			...
			for (let i = 0; i < lines.length; i++) {
				...
				if (tokens[0] == "v") {
					_vertices.push(new __WEBPACK_IMPORTED_MODULE_4__Vertex__["a" /* Vertex */](new __WEBPACK_IMPORTED_MODULE_3__math_vector_Vector3f__["a" /* Vector3f */](+tokens[1], +tokens[2], +tokens[3])));
				}

				if (tokens[0] == "vn") {
					_normals.push(new __WEBPACK_IMPORTED_MODULE_3__math_vector_Vector3f__["a" /* Vector3f */](+tokens[1], +tokens[2], +tokens[3]));
				}

				if (tokens[0] == "vt") {
					_texCoords.push(new __WEBPACK_IMPORTED_MODULE_2__math_vector_Vector2f__["a" /* Vector2f */](+tokens[1], +tokens[2]));
				}
	...
	var parseTriangleFace = function (tokens) {
		...
		if (tokens[1].includes("//")) {
			let vertexIndices = [+tokens[1].split("//")[0] - 1, +tokens[2].split("//")[0] - 1, +tokens[3].split("//")[0] - 1];

			let normalIndices = [+tokens[1].split("//")[1] - 1, +tokens[2].split("//")[1] - 1, +tokens[3].split("//")[1] - 1];
			...
			if (tokens[1].split("/").length == 3) {
				...
				let texCoordIndices = [+tokens[1].split("/")[1] - 1, +tokens[2].split("/")[1] - 1, +tokens[3].split("/")[1] - 1];

				let normalIndices = [+tokens[1].split("/")[2] - 1, +tokens[2].split("/")[2] - 1, +tokens[3].split("/")[2] - 1];
			...
			let vertexIndices = [+tokens[1] - 1, +tokens[2] - 1, +tokens[3] - 1];
	...
	var parseQuadFace = function (tokens) {
		...
		if (tokens[1].includes("//")) {
			...
			let vertexIndices = [+tokens[1].split("//")[0] - 1, +tokens[2].split("//")[0] - 1, +tokens[3].split("//")[0] - 1, +tokens[4].split("//")[0] - 1];

			let normalIndices = [+tokens[1].split("//")[1] - 1, +tokens[2].split("//")[1] - 1, +tokens[3].split("//")[1] - 1, +tokens[4].split("//")[1] - 1];
			...
			if (tokens[1].split("/").length == 3) {
				...
				let texCoordIndices = [+tokens[1].split("/")[1] - 1, +tokens[2].split("/")[1] - 1, +tokens[3].split("/")[1] - 1, +tokens[4].split("/")[1] - 1];

				let normalIndices = [+tokens[1].split("/")[2] - 1, +tokens[2].split("/")[2] - 1, +tokens[3].split("/")[2] - 1, +tokens[4].split("/")[2] - 1];
		...
		// vertex
				...
				let vertexIndices = [+tokens[1] - 1, +tokens[2] - 1, +tokens[3] - 1, +tokens[4] - 1];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__math_vector_Vector2f__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__math_vector_Vector3f__ = __webpack_require__(1);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__LoaderUtil__ = __webpack_require__(8);
...
module.exports = __webpack_require__.p + "meshes/spartan.obj";
...
function Texture(name, source) {
	// initialization
	var _name = name;
	var _object = __WEBPACK_IMPORTED_MODULE_0__index__["gl"].createTexture();
	var _image = new Image();

	__WEBPACK_IMPORTED_MODULE_0__index__["gl"].bindTexture(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_2D, _object);

	if (source) {
		__webpack_require__(33)("./" + source);
		_image.src = "/images/" + source;
	}

	var active = function (location) {
		if (location >= 0 && location < 31) {
			__WEBPACK_IMPORTED_MODULE_0__index__["gl"].aciveTexture(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE0 + location);
		} else {
	...
	this.unbind = function () {
		__WEBPACK_IMPORTED_MODULE_0__index__["gl"].bindTexture(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_2D, null);
	};

	this.destroy = function () {
		__WEBPACK_IMPORTED_MODULE_0__index__["gl"].deleteTexture(_object);
	};

	this.noFilter = function () {
		__WEBPACK_IMPORTED_MODULE_0__index__["gl"].texParameteri(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_2D, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_MAG_FILTER, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].NEAREST);
		__WEBPACK_IMPORTED_MODULE_0__index__["gl"].texParameteri(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_2D, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_MIN_FILTER, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].NEAREST);
	};

	this.bilinearFilter = function () {
		__WEBPACK_IMPORTED_MODULE_0__index__["gl"].texParameteri(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_2D, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_MAG_FILTER, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].LINEAR);
		__WEBPACK_IMPORTED_MODULE_0__index__["gl"].texParameteri(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_2D, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_MIN_FILTER, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].LINEAR);
	};

	this.repeatWrap = function () {
		__WEBPACK_IMPORTED_MODULE_0__index__["gl"].texParameteri(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_2D, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_WRAP_S, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].REPEAT);
		__WEBPACK_IMPORTED_MODULE_0__index__["gl"].texParameteri(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_2D, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_WRAP_T, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].REPEAT);
	};

	this.mirrorRepeatWrap = function () {
		__WEBPACK_IMPORTED_MODULE_0__index__["gl"].texParameteri(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_2D, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_WRAP_S, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].MIRRORED_REPEAT);
		__WEBPACK_IMPORTED_MODULE_0__index__["gl"].texParameteri(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_2D, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_WRAP_T, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].MIRRORED_REPEAT);
	};
	...
	this.bind();
	__WEBPACK_IMPORTED_MODULE_0__index__["gl"].pixelStorei(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].UNPACK_FLIP_Y_WEBGL, true);
	__WEBPACK_IMPORTED_MODULE_0__index__["gl"].texImage2D(__WEBPACK_IMPORTED_MODULE_0__index__["gl"].TEXTURE_2D, 0, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].RGBA, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].RGBA, __WEBPACK_IMPORTED_MODULE_0__index__["gl"].UNSIGNED_BYTE, _image);
	this.noFilter();
};
...
module.exports = __webpack_require__.p + "images/cube.png";

/***/ }),
/* 35 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "images/spartan.png";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Mouse__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__math_Maths__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__matrix_Matrix4f__ = __webpack_require__(3);
...
function Maths() {
  ...
  */
	this.createViewMatrix = function (camera) {
		...
		var negativeCameraPosition = new __WEBPACK_IMPORTED_MODULE_1__vector_Vector3f__["a" /* Vector3f */](-camera.getPosition().x, -camera.getPosition().y, -camera.getPosition().z);
